...
public class Bascule_RSTest {
    ...
    public void testInitialState() {
        assertEquals("BASCULE RS", bascule.getGateType());
    ...
    public void testSetInputs() {
        ...
        Fils input1 = new Fils(0, 0, circuit, null, null);
        Fils input2 = new Fils(0, 0, circuit, null, null);
    ...
    private void setInputs(QuadBool R, QuadBool S) {
        Fils inputR = new Fils(0, 0, circuit, null, null);
        Fils inputS = new Fils(0, 0, circuit, null, null);
        inputR.setOutput(R);
        inputS.setOutput(S);
